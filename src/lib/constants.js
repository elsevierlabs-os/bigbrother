...
export const BROWSER_CANT_OPEN_PAGE_MESSAGE = "Can't open a new page, browser hasn't been launched.";
export const BROWSER_CANT_CLOSE_MESSAGE = "Can't close, browser hasn' been launched yet.";

export const REPORT_FILENAME_ROOT = 'report_bigbrother_';
